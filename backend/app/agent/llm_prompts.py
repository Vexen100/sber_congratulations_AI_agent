...
def build_system_prompt() -> str:
    return (
        ...
        "- Не упоминай тему/вид последнего взаимодействия с клиентом; можно использовать только общую благодарность.\n"
        "- Проверь грамматику и согласование в русском языке.\n"
...
def build_user_prompt(
    *,
    ...
    return (
        ...
        "- Добавь 1-2 фразы персонализации на основе FACTS (компания/должность), без выдуманных деталей\n"
        "- Добавь одну общую фразу благодарности: «Спасибо, что остаётесь с нами» (без упоминания тем контактов)\n"
        "- Избегай однотипности: не начинай все тексты одинаково, используй разные формулировки\n"
